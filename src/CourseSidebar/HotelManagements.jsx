        ...
        <div className="row">
              ...
              {showContent ? (
                <>
                  ...
                  <p>
                    ...
                    pursue a career in the hospitality sector. Bachelors and
                    Masters in Hotel Management (BHM and MHM) are the top hotel
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 1.24 to 2.56 LPA</small>
              </p>
              <p className="card-text">
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 3 - 10 LPA</small>
              </p>
              <p className="card-text">
                <small className="text-muted">⌛Duration: 3 Years</small>
              </p>
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 20K - 1.5 LPA</small>
              </p>
              <p className="card-text">
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 2 - 4 LPA</small>
              </p>
              <p className="card-text">
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 1 - 5 LPA</small>
              </p>
              <p className="card-text">
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 40,000 - 5 LPA</small>
              </p>
              <p className="card-text">
                <small className="text-muted">⌛Duration: 3 Years</small>
              </p>
