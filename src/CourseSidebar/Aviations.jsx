        ...
        <div className="row">
              ...
              {showContent ? (
                <>
                  ...
                  <p>
                    ...
                    cabin crew can pursue Aviation courses after className 10 or 12.
                    ...
                    training and flying classNamees. Courses like BTech Aerospace
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 60,000 to INR 1 LPA</small>
              </p>
              <p className="card-text">
          ...
          >
            <div className="card-body">
              ...
              <p className="card-text">
                <small className="text-muted">💰Avarage fees: 1 to 8 LPA
</small>
              </p>
              <p className="card-text">
