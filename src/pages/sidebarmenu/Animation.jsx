      ...
      <div className="container p-3 my-3 border border-dark ">
        <div className="row">
              ...
              {showContent ? (
                <>
                  ...
                  <p>
                    ...
                    the national, university, or state level. Here, were giving you all the
          ...
          >
            ...
            <p className="card-text">Government colleges have an average fee ranging from INR 10K, 
            to INR 75K per annum while private colleges have fees in the range,
            INR 50K to INR 5 Lakhs Per Annum.</p>
            <p className="card-text"><small className="text-muted">💰Avarage fees: ---</small></p>
            <p className="card-text"><small className="text-muted">⌛Duration: 3 Years</small></p>
          </div>
